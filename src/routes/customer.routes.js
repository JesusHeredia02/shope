...
import { addCustomer, getCustomer, getCustomers, deleteCustomer, updateCustomer } from "../controllers/customer.controllers.js";
import { Router } from "express";

const customerRouter = Router();

customerRouter.get("/customer", getCustomers); // Obtener todos los clientes
customerRouter.get("/customers/:id", getCustomer); // Obtener un cliente por su ID
